		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckLibvirtVolumeExists("libvirt_volume.gzip-qcow2-tar", &volume),
					testAccCheckLibvirtVolumeExists("libvirt_volume.bzip2-raw", &volume),
					testAccCheckLibvirtVolumeExists("libvirt_volume.bzip2-raw-tar", &volume),
					testAccCheckLibvirtVolumeExists("libvirt_volume.bzip2-qcow2", &volume),
					testAccCheckLibvirtVolumeExists("libvirt_volume.bzip2-qcow2-tar", &volume),
				),
			},
		},
	})
