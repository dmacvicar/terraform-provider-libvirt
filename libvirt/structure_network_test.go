...
func TestFlattenNetworkDNS(t *testing.T) {
...
func TestFlattenNetworkAddresses(t *testing.T) {
...
func TestFlattenNetworkDHCP(t *testing.T) {
...
func TestFlattenNetworkRoutes(t *testing.T) {
	cases := []struct {
	...
	for _, tc := range cases {
		output := flattenNetworkRoutes(tc.Input)
		assert.Equal(t, tc.ExpectedOutput, output)
	}
}
