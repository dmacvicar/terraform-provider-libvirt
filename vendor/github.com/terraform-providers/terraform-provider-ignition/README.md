...
```sh
$ git clone git@github.com:terraform-providers/terraform-provider-$PROVIDER_NAME $GOPATH/src/github.com/terraform-providers/terraform-provider-$PROVIDER_NAME
```
